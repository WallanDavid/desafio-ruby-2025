...
ActiveRecord::Schema[7.1].define(version: 4) do
  ...
  create_table "processing_logs", force: :cascade do |t|
    ...
    t.index ["ingested_email_id"], name: "index_processing_logs_on_ingested_email_id"
    t.index ["parser"], name: "index_processing_logs_on_parser"
    t.index ["status"], name: "index_processing_logs_on_status"
  end

  add_foreign_key "active_storage_attachments", "active_storage_blobs", column: "blob_id"
  add_foreign_key "active_storage_variant_records", "active_storage_blobs", column: "blob_id"
  add_foreign_key "processing_logs", "ingested_emails"
end
